...
ggsave("Argentina/Output/map_share_spanish_arg_1970_v2.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggsave("Argentina/Output/map_share_spanish_arg_1980_v2.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(censo_arg_1970_filter, aes(x = yrimm, weight = perwt)) +
  ...
  annotate("text", x = 1945.5, y = 65000,
           label = "Presumed\nexile window",
           color = "steelblue4", size = 3.5, fontface = "bold") +
  annotate("text", x = 1967, y = 65000,
           label = "Documented\nexile window",
           color = "tomato3", size = 3.5, fontface = "bold") +
  labs(
    title = "Year of arrival of Spanish-born population in Argentina (Census 1970)",
    subtitle = "Weighted counts using census sampling weights",
    x = "Year of arrival",
...
ggsave("Argentina/Output/hist_yrimm_arg_1970_v2.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggsave("Argentina/Output/hist_yrimm_arg_1980_v2.png", width = 8, height = 6, dpi = 300, bg = "white")
